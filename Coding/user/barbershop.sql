...
CREATE TABLE bookings (
    ...
    status ENUM('pending','selesai','cancelled') DEFAULT 'pending',
    biaya_admin INT DEFAULT 2000,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO settings (nama_barbershop, tagline, qris_image_url, biaya_admin) VALUES
('King Barbershop', 'Style Starts Here', '', 2000);

-- Default admin: username = admin, password = admin123
-- Password hash generated with password_hash('admin123', PASSWORD_DEFAULT)
INSERT INTO admin_users (username, password) VALUES
('admin', '$2y$10$erxWVc5T7Uz3MSlT5wLzveD80nI4NcocgVlVEc7BegHahtmVk9UGS');
